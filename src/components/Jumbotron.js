    ...
    return (
        <>
            ...
            <div className="grid grid-cols-2 max-sm:grid-cols-1 text-[4vw] max-sm:text-center max-sm:text-[6vw] font-bold px-16 py-0">
                <div>
                    <h1 className="leading-[4vw] max-sm:leading-[7vw] tracking-tight">Unleash Your Home`s Potential with <span className="text-color-accent2">Furnicraft</span> marketplace</h1>
