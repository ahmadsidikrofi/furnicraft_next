            ...
            <div className="grid grid-cols-2 max-sm:grid-cols-1 text-[4vw] max-sm:text-center max-sm:text-[6vw] font-bold px-16 py-[10vh] gap-10">
                <div>
                    ...
                    <div className="max-sm:pb-4 flex max-sm:justify-center max-sm:items-center gap-4 text-sm font-medium items-center">
                        <Link href={'/furnitures'} className="py-3 px-4 text-color-primary bg-color-accent2 rounded-full hover:shadow-lg sm:hidden md:block">Shop Now</Link> 
                        <p className="font-semibold sm:hidden md:block">or</p>
                        <Link href={'/dashboard/stores'} className="py-3 px-4 border-[1px] border-color-grey border-opacity-15 rounded-full hover:shadow-xl sm:hidden md:block">Cash in today</Link>
                    </div>
                </div>
