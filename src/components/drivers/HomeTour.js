...
const HomeTour = () => {
    useEffect(() => {
        const userHasTouring = localStorage.getItem("UserHasTouring")
        const driverObj = driver({
            ...
            steps: [
                ...
                { popover: { title: 'And that is all!', description: 'Pergilah dan eksplorasi sendiri dengan kemauanmu. Tugasku hanya sampai sini dalam memandu para customer.' } }
            ]
        })
        // if (!userHasTouring) {
